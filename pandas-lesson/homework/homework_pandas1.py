...
# --------
# Замініть типи не числових колонок на числові
table[["2014", "2019"]] = table[["2014", "2019"]].apply(
    pd.to_numeric, errors='coerce')  # не працювала заміна, зробив errors='coerce'
...
# Ваші дані у таблиці
# table = pd.DataFrame(...)  # таблиця даних

# Створення стовпчикової діаграми для колонки "2019"
table["2019"].plot(kind="bar")

# Налаштування заголовку та підписів осей
plt.title("Діаграма за 2019 рік")
plt.xlabel("Індекс")
plt.ylabel("Значення")
